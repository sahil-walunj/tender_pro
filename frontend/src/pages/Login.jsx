...
function Login({ setIsAuthenticated, setUserRole }) {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/${role}/login`, {
                method: "POST",
            ...
            <div className="p-4 grid grid-cols-1 lg:grid-cols-8 justify-center bg-[#C5C1C0] flex-1">
                ...
                <div className="hidden lg:flex flex-col col-span-2">
                    <div className="mt-[20vh]">
                        <div className="p-0 font-regular text-[3.2rem]">Sign in to</div>
                        <div className="p-0 font-semibold text-[2.5em]">TenderPro</div>
                        <div className="p-2"></div>
                        <div className="p-0 font-regular text-[0.8rem]">If you don't have an account</div>
                        <div className="p-0 font-regular text-[0.8rem]">
                            <a className="underline text-blue-950" href="http://localhost:5173/signup">Signup</a>
                        </div>
                    </div>
                </div>
